            ...
            <Row>
                ...
                <Col md={6}>
                    <div className="trial_text">
                        ...
                        <p>Find the right web developer for your business takes time and research, but by knowing what you’re looking for</p>
                        <div className="trial_flex">
                        <div className="trial_btn">
                            <button className='trial_left_btn' ><NavLink to={'/service'}>Service</NavLink></button>
                           <button className='trial_right_btn'><NavLink to={'/register'}>Join LightX</NavLink></button>
                           <span>OR</span>
                        </div>
                        </div>
                    </div>
